...
def _normalize_subject_type(subject_type: str | None) -> str | None:
...
def _normalize_value_identity(value: str | None) -> str | None:
...
def build_fact_key(candidate: CandidateMemory, *, subject_id: str | None) -> str | None:
    ...
    subject_type = _normalize_subject_type(candidate.subject_type)
    ...
    value_identity = _normalize_value_identity(candidate.value)
